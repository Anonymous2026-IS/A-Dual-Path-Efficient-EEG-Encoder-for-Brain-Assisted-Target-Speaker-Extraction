...
class cock_tail(Dataset):
    def __init__(self, root, mode, subject=None):
        ...
        if mode == 'train':
            ...
            # self.file_path = os.path.join(root, 'AVED20/Normalized_male20/2s/eeg/new')
            # self.file_path = os.path.join(root, 'AVED50/Normalized_male50-2/2s/eeg/new')
            ...
            # self.file_path = os.path.join(root, 'AVED20/Normalized_male20/20s/eeg/new')
            # self.file_path = os.path.join(root, 'AVED50/Normalized_male50-2/20s/eeg/new')
